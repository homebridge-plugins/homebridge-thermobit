...
class ThermobitPlatform {
  ...
  initialiseDevice () {
    ...
    try {
      ...
      this.accessory.control = new (require('./device/temp-sensor'))(this)
  ...
  addAccessory () {
    ...
    try {
      const uuid = this.api.hap.uuid.generate(this.config.username)
      const accessory = new this.api.platformAccessory('Thermobit', uuid)
      accessory
        .getService(this.api.hap.Service.AccessoryInformation)
        .setCharacteristic(this.api.hap.Characteristic.Name, 'Thermobit')
        .setCharacteristic(this.api.hap.Characteristic.ConfiguredName, 'Thermobit')
        .setCharacteristic(this.api.hap.Characteristic.Manufacturer, 'Thermobit')
        .setCharacteristic(this.api.hap.Characteristic.SerialNumber, 'Thermobit')
        .setCharacteristic(this.api.hap.Characteristic.Model, 'Thermobit')
